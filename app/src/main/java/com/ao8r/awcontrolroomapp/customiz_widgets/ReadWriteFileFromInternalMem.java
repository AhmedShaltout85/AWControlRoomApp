package com.ao8r.awcontrolroomapp.customiz_widgets;


import static com.ao8r.awcontrolroomapp.utils.ControlRoomConstants.BASE_IP;
...
//    File root = new File(Environment.getExternalStorageDirectory(), BASE_IP);
    ...
    File file = new File(root, ControlRoomConstants.LOGIN_FILE_NAME);
    ...
    public static void generateNoteOnSD( String sBody) {
        try {
            ...
            File sdFile = new File(root, ControlRoomConstants.LOGIN_FILE_NAME);
