...
import static com.ao8r.awcontrolroomapp.utils.ControlRoomConstants.URL_CONNECT_LINK;
...
import com.ao8r.awcontrolroomapp.customiz_widgets.ReadWriteFileFromInternalMem;
import com.ao8r.awcontrolroomapp.repository.LoginRepo;
import com.ao8r.awcontrolroomapp.services.InternetConnection;
...
////
        ...
        loginUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ControlRoomConstants.LOGIN_USER = loginName.getText().toString();
...
//                loginPassword.requestFocus();
                ...
                if (rememberMe.isChecked()) {
                    ...
                    editor.putString("name", ControlRoomConstants.LOGIN_USER);
...
//                Check users Authority
                ...
                if (ControlRoomConstants.LOGIN_USER.trim().length() == 0 || password.length() == 0) {
