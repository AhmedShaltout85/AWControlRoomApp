package com.ao8r.awcontrolroomapp.utils;


public class ControlRoomConstants {
    ...
    public static String STORE_NUMBER = "0";
...
//    public static final String ABOUT_APP = "حول التطبيق";
    ...
    public static final String LOGIN_FILE_NAME = "controlRoomBaseIp.txt";
